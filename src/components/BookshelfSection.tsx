...
const books: Book[] = [
  ...
  { title: "The Alchemist", author: "Paulo Coelho", cover: bookAlchemist, category: "Others", spine: "#2a1a0a" },
  { title: "Atomic Habits", author: "James Clear", cover: bookAtomicHabits, category: "Others", spine: "#0a1a0a" },
  { title: "Clean Code", author: "Robert C. Martin", cover: bookCleanCode, category: "Others", spine: "#1a1a1a" },
  { title: "Rich Dad Poor Dad", author: "Robert Kiyosaki", cover: bookRichDad, category: "Others", spine: "#2a1a00" },
